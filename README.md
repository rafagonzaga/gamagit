# gamagit
Projeto desenvolvido durante as aulas de React do Hiring Coders, da Gama Academy.
...
## Motivação
Durante as aulas foram trabalhados conceitos fundamentais de React através da construção de uma aplicação simples e funcional. Os conceitos abordados foram:
- Hooks;
- Componentes;
- Propriedades;
- Estado;
